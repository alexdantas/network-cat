...
public:
    ...
    ///
    /// Terminal escape codes look like this (\e[1;31m) and, at
    /// terminals, they make the text colored.
    /// That becomes strange when you redirect that output to
    /// a file.
    ///
    /// @note When you select the output mode to a file, this
    ///       class automatically disables the escape codes.
